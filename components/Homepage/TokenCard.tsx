...
function TokenCard({}: Props) {
  return (
    <div className=" w-1/2 p-8 overflow-hidden ">
      <div className="bg-[url('/cardbg.png')] bg-cover flex bg-no-repeat rounded-xl">
        <div className="flex flex-col justify-between w-full max-w-[27rem] p-10 pb-8 pt-14 items-start text-left">
