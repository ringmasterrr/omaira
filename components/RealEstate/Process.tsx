...
const ProcessCard: React.FC<ExpertiseAndExperienceProps> = ({
  ...
  return (
    <section
      className="flex flex-col items-start text-left lg:items-start max-w-[30rem] p-8 justify-start border rounded-3xl md:gap-16 gap-8 md:pb-16 pb-8 md:min-h-[25rem]  "
      ...
      <div className=" w-full mx-auto my-8 flex-col px-2 lg:px-0 lg:flex-row flex  items-center justify-center  ">
        <div className=" max-w-screen-2xl flex w-full items-center justify-center">
          <div className="flex flex-col items-center justify-center">
            <div className="flex-col gap-4 items-center justify-center flex">
