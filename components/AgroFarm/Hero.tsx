      ...
      >
        <div className="flex flex-col gap-12 xl:w-[50%] w-[80%]  ">
          <div className="flex flex-col md:items-start gap-4">
            <span className="2xl:text-4xl lg:2xl xl:3xl text-4xl pb-0  md:text-left text-center">
              Tokenization of Agro Farms:
            </span>
            <span className="2xl:text-4xl lg:2xl xl:3xl text-4xl font-bold text-sky-400 md:text-left text-center">
              Digitizing Agricultural Assets
            </span>
          </div>

          <div className="space-y-4">
            <h3 className="text-2xl font-bold md:text-left text-center">Introduction</h3>
